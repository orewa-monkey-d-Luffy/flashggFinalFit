...
#     dirext="${tag}_${year}_${ext}_WHInt_fa3"
#     datacard_name="Datacard_${tag}_${year}_${ext}_ANOM_STXS_WHInt_fa3"
...
#     dirext="${tag}_${year}_${ext}_ZHInt_fa3"
#     datacard_name="Datacard_${tag}_${year}_${ext}_ANOM_STXS_ZHInt_fa3"
...
# #combined WH (Int)
# procs="wh_ALT_0M,wh_ALT_0PM,wh_ALT_0Mf05"
# dirext="${tag}_combined_${ext}_WHInt_fa3"
# datacard_name="Datacard_${tag}_combined_${ext}_ANOM_STXS_WHInt_fa3"
...
#combined ZH (Int)
procs="zh_ALT_0M,zh_ALT_0PM,zh_ALT_0Mf05"
dirext="${tag}_combined_${ext}_ZHInt_fa3"
datacard_name="Datacard_${tag}_combined_${ext}_ANOM_STXS_ZHInt_fa3"
...
# procs="wh_ALT_0M,wh_ALT_0PM"
# dirext="Nov23_combined_2023_11_14_WHInt_fa3"
